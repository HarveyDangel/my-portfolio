...
export const projects: ProjectDetails[] = [
	{
		...
		imageUrl: "/images/EventMS.webp",
		galleryUrls: [
			{ src: "/images/eventms/login.webp", alt: "Login Page" },
			{ src: "/images/eventms/dashboard.webp", alt: "Dashboard Page" },
			{ src: "/images/eventms/events.webp", alt: "Events Page" },
			{ src: "/images/eventms/addevents.webp", alt: "Add Events Page" },
			{ src: "/images/eventms/feedback.webp", alt: "Feedback Page" },
			{ src: "/images/eventms/history.webp", alt: "History Page" },
		],
	...
	},
	{
		...
		imageUrl: "/images/MMSGSM.webp",
		galleryUrls: [
			{ src: "/images/gsmmms/children.webp", alt: "Children Tab" },
			{ src: "/images/gsmmms/dashboard.webp", alt: "Dashboard Page" },
			{ src: "/images/gsmmms/map.webp", alt: "Map Page" },
			{ src: "/images/gsmmms/report.webp", alt: "Report Page" },
		],
